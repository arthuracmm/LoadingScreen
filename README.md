**Título do Projeto: HTML/CSS Loading Screen**

**Descrição:**
Este projeto é uma animação criada em HTML e CSS, foi criado com o intuito de auxiliar devs com uma tela de carregamento para seu sistema.
